...
export default function TaskTable(
    ...
    return(
        <>
            {
                success && (<div className="bg-emerald-400 py-2 px-4 text-white rounded mb-4">
                    {success}
                </div>)
            }
                ...
                <tbody>
                    {tasks.data.map((task) => (
                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700" key={task.id}>
                            ...
                            {!hideProjectColumn && <td className="px-3 py-2 text-white hover:underline">
